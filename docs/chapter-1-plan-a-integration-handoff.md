...
10. Player defeat currently resets the entire technical route after a short delay. There is no Chapter 1 checkpoint or encounter-local reset policy, so a late boss or tower failure would erase all mining and clue progress.
